        ...
        <div className="bg-customWhite font-dmsans max-w-[1700px] w-full mx-auto">
            <div
                ...
                <div className="relative z-20 text-center">
                    <h1 className="text-white text-[60px] xs:text-[32px] sm:text-[36px] md:text-[50px] font-extrabold text-center">Contact
                        Us</h1>
                </div>
            </div>
            <div
                className="container xs:p-2 w-1/2 xl:w-3/5 lg:w-3/4 md:w-3/4 sm:w-[80%] xs:w-full mx-auto">
                <h3 className='text-[#282938] text-center font-bold mb-7 xs:mb-3 sm:mb-4 text-[20px]'>Get In Touch</h3>
                <h1 className='text-[#333333] text-[60px] xs:text-[32px] sm:text-[36px] md:text-[50px] font-extrabold text-center mb-8 xs:mb-3 sm:mb-4 '>Contact
                    Us</h1>
                <p className='mb-20 xs:mb-12 sm:mb-14 md:mb-16 font-normal text-[#555555] text-center'>We’re here to
                    help! Whether you have a question or need support, feel free to reach out through the contact form
                    below, or by email or phone. We look forward to hearing from you! </p>
                ...
                <form>
                    ...
                    <label>
                        ...
                        <select name="choose-a-topic" id="choose-a-topic" required
                                className='mb-8 p-4 text-[1rem] text-[#282938] border border-customTealBlue outline-none rounded-[6px] w-full bg-customWhite'>
